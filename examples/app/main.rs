...
//
// ui.rs is generated by: lua scripts/layout.lua < examples/ui.lua > examples/app/ui.rs
...
fn nav(args: &[&str]) -> Option<ui::Menu> {
    match args.first().copied().unwrap_or("") {
        "Borders"   => Some(ui::Menu::Borders),
        "Clickable" => Some(ui::Menu::Clickable),
        "Complex"   => Some(ui::Menu::Complex),
        "DynStat"   => Some(ui::Menu::DynStat),
        "Grid"      => Some(ui::Menu::Grid),
        "Margin"    => Some(ui::Menu::Margin),
        "Pad"       => Some(ui::Menu::Pad),
        "Popup"     => Some(ui::Menu::Popup),
        "Simple"    => Some(ui::Menu::Simple),
        "Styled"    => Some(ui::Menu::Styled),
        "SubStyled" => Some(ui::Menu::SubStyled),
        "Unequal"   => Some(ui::Menu::Unequal),
        "Widget"    => Some(ui::Menu::Widget),
        _           => None,
    }
}
