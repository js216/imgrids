...
menus = {
   ...
   Hello = {"col",
      {"[1/28] Col Layout",                                        size = 40, style = s_title},
   ...
   Rows = {"col",
      {"[2/28] Row Layout",                                        size = 40, style = s_title},
   ...
   Cols = {"col",
      {"[3/28] Col + Row Nesting",                                 size = 40, style = s_title},
   ...
   Weighted = {"col",
      {"[4/28] Proportional Weights",                               size = 40, style = s_title},
   ...
   Fixed = {"col",
      {"[5/28] Fixed Sizes",                                       size = 40, style = s_title},
   ...
   CellStyle = {"col",
      {"[6/28] Cell Styling",                                      size = 40, style = s_title},
   ...
   LeafStyle = {"col",
      {"[7/28] Leaf Style",                                       size = 40, style = s_title},
   ...
   ContainerBg = {"col",
      {"[8/28] Container Background",                              size = 40, style = s_title},
   ...
   Pad = {"col",
      {"[9/28] Padding",                                           size = 40, style = s_title},
   ...
   Margin = {"col",
      {"[10/28] Margins",                                           size = 40, style = s_title},
   ...
   FlushCells = {"col",
      {"[11/28] Flush Cells",                                       size = 40, style = s_title},
   ...
   Borders = {"col",
      ...
      {"[12/28] Borders",                                           size = 40, style = s_title},
   ...
   ContainerBorder = {"col",
      {"[13/28] Container Border",                                  size = 40, style = s_title},
      ...
      {"row",
         ...
         {"col", border = {width = 2, color = colors.red},
            {"Red F"},
         },
      },
   },
   ...
   Clickable = {"col",
      {"[14/28] Press Callbacks",                                   size = 40, style = s_title},
   ...
   Focusable = {"col",
      {"[15/28] Focus Behavior",                                    size = 40, style = s_title},
   ...
   FocusDisable = {"col",
      {"[16/28] Focus Disable",                                     size = 40, style = s_title},
   ...
   Dynamic = {"col",
      {"[17/28] Dynamic Labels",                                    size = 40, style = s_title},
   ...
   DynUpdate = {"col",
      {"[18/28] Dynamic Update API",                                size = 40, style = s_title},
   ...
   Progress = {"col",
      {"[19/28] Progress Bar",                                      size = 40, style = s_title},
   ...
   Complex = {"col",
      {"[20/28] Nested Containers",                                 size = 40, style = s_title},
   ...
   Alignment = {"col",
      {"[21/28] Text Alignment",                                    size = 40, style = s_title},
   ...
   AlignStyle = {"col",
      {"[22/28] Align in Style Tables",                             size = 40, style = s_title},
   ...
   MultilineAlign = {"col",
      {"[23/28] Multiline Alignment",                               size = 40, style = s_title},
   ...
   DynAlign = {"col",
      {"[24/28] Dynamic Label Alignment",                           size = 40, style = s_title},
   ...
   FontIcons = {"col",
      {"[25/28] Font Fallback + Icons",                             size = 40, style = s_title},
      {"Font chain: primary + FontAwesome fallback.\nIcons render from FA when missing in primary.", size = 50, style = s_desc},
      nav("DynAlign", "ExtraChars"),
      {"row", leaf_style = {font = fonts.myriad_icons},
         {SYMBOL_HOME .. " Home"},
   ...
   ExtraChars = {"col",
      {"[26/28] Extra Characters",                                  size = 40, style = s_title},
      {"extra={...} in font spec adds non-ASCII\ncode points like " .. PLUS_MINUS .. " " .. MICRO .. " " .. DEGREE .. " to the atlas.", size = 50, style = s_desc},
      nav("FontIcons", "FontChainExtra"),
      {"row", leaf_style = {font = fonts.myriad_extra},
         {PLUS_MINUS .. "0.5V"},
         {"100" .. MICRO .. "A"},
         {"23.1" .. DEGREE .. "C"},
      },
   ...
   FontChainExtra = {"col",
      {"[27/28] Font Chain + Extra",                                size = 40, style = s_title},
      {"Chain + extra: MyriadPro + FontAwesome +\nextra code points, all in one font spec.", size = 50, style = s_desc},
      nav("ExtraChars", "Popup"),
      {"row", leaf_style = {font = fonts.myriad_icons_extra},
         {SYMBOL_HOME .. " " .. PLUS_MINUS .. "5V"},
         {SYMBOL_SETTINGS .. " 25" .. DEGREE .. "C"},
         {SYMBOL_OK .. " " .. MICRO .. "A ok"},
      },
   },
