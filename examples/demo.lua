...
menus = {
   ...
   Hello = {"col",
      {"[1/32] Col Layout",                                        size = 40, style = s_title},
   ...
   Rows = {"col",
      {"[2/32] Row Layout",                                        size = 40, style = s_title},
   ...
   Cols = {"col",
      {"[3/32] Col + Row Nesting",                                 size = 40, style = s_title},
   ...
   Weighted = {"col",
      {"[4/32] Proportional Weights",                               size = 40, style = s_title},
   ...
   Fixed = {"col",
      {"[5/32] Fixed Sizes",                                       size = 40, style = s_title},
   ...
   CellStyle = {"col",
      {"[6/32] Cell Styling",                                      size = 40, style = s_title},
   ...
   LeafStyle = {"col",
      {"[7/32] Leaf Style",                                       size = 40, style = s_title},
   ...
   ContainerBg = {"col",
      {"[8/32] Container Background",                              size = 40, style = s_title},
   ...
   Pad = {"col",
      {"[9/32] Padding",                                           size = 40, style = s_title},
   ...
   Margin = {"col",
      {"[10/32] Margins",                                           size = 40, style = s_title},
   ...
   FlushCells = {"col",
      {"[11/32] Flush Cells",                                       size = 40, style = s_title},
   ...
   Borders = {"col",
      ...
      {"[12/32] Borders",                                           size = 40, style = s_title},
   ...
   ContainerBorder = {"col",
      {"[13/32] Container Border",                                  size = 40, style = s_title},
   ...
   Clickable = {"col",
      {"[14/32] Press Callbacks",                                   size = 40, style = s_title},
   ...
   Focusable = {"col",
      {"[15/32] Focus Behavior",                                    size = 40, style = s_title},
   ...
   FocusDisable = {"col",
      {"[16/32] Focus Disable",                                     size = 40, style = s_title},
   ...
   Dynamic = {"col",
      {"[17/32] Dynamic Labels",                                    size = 40, style = s_title},
   ...
   DynUpdate = {"col",
      {"[18/32] Dynamic Update API",                                size = 40, style = s_title},
   ...
   Progress = {"col",
      {"[19/32] Progress Bar",                                      size = 40, style = s_title},
   ...
   Complex = {"col",
      {"[20/32] Nested Containers",                                 size = 40, style = s_title},
   ...
   Alignment = {"col",
      {"[21/32] Text Alignment",                                    size = 40, style = s_title},
   ...
   AlignStyle = {"col",
      {"[22/32] Align in Style Tables",                             size = 40, style = s_title},
   ...
   MultilineAlign = {"col",
      {"[23/32] Multiline Alignment",                               size = 40, style = s_title},
   ...
   DynAlign = {"col",
      {"[24/32] Dynamic Label Alignment",                           size = 40, style = s_title},
   ...
   FontIcons = {"col",
      {"[25/32] Font Chain + Icons + Extra",                        size = 40, style = s_title},
...
menus.FocusGroups = {"col",
   {"[26/32] Focus Groups",                                       size = 40, style = s_title},
...
menus.Overload = {"col",
   {"[27/32] Progress Bar Overload",                               size = 40, style = s_title},
...
menus.Icons = {"col",
   {"[28/32] SVG Icons",                                          size = 40, style = s_title},
...
menus.ActiveStyle = {"col",
   {"[29/32] Active Styling",                                     size = 40, style = s_title},
...
menus.MidString = {"col",
   ...
   {"row", size = 50,
      multipart = {
         ...
         {" mixed ", font = fonts.myriad_small, fg = colors.yellow},
         {"fonts!", font = fonts.roboto_large, fg = colors.blue},
      },
   },
   {"row", size = 50,
      multipart = {
         {"Hello ", font = fonts.myriad_large, fg = colors.white},
         {"World", font = fonts.roboto_large, fg = colors.green},
      },
   },
   {"Each row uses multipart= to chain\nblit calls with different atlases.\nAll rendered in a single cell.", style = {border = {width = 0}}},
}
