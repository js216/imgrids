/// A native framebuffer pixel: RGB565 packed as 0bRRRRR_GGGGGG_BBBBB.
/// Matches the hardware directly — renderers copy_from_slice into the mmap
/// with no per-frame conversion.
pub type Pixel = u16;
...
pub const BLACK:  Pixel = rgb(0x00, 0x00, 0x00);
