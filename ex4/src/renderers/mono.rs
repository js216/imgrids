    ...
    fn bake(font: &FontVec, cell_h: usize, fg: Pixel, bg: Pixel) -> Self {
        ...
        for code in 0u8..128 {
            ...
            blend_into(
                ...
                &alpha, fg_r, fg_g, fg_b, bg_r, bg_g, bg_b,
            );
        }

        MonoAtlas { cell_w, cell_h, glyphs }
    }
...
pub(super) fn channels(fg: Pixel, bg: Pixel)
    -> (u32, u32, u32, u32, u32, u32)
{
    ...
    (
        ch(fg, 11, 0x1F, 3), ch(fg, 5, 0x3F, 2), ch(fg, 0, 0x1F, 3),
        ch(bg, 11, 0x1F, 3), ch(bg, 5, 0x3F, 2), ch(bg, 0, 0x1F, 3),
    )
}
